...
async function startVosk() {
    if (voiceActive) return;
    if (voskLoading) {
        showToast('در حال بارگذاری', 'مدل صوتی در حال آماده‌سازی...', 'info');
        return;
    }
    ...
    const progressContainer = document.getElementById('voskProgress');
    ...
    try {
        ...
        if (statusEl) {
            statusEl.textContent = '❌ ' + (e.message || 'مشکل نامشخص');
...
if (lower.includes('small font') || lower.includes('فونت کوچک') || lower.includes('فونت معمولی')) {
    ...
    return;
        ...
        // ---- Chatty responses (nurses' small talk) ----
    const chatKeywords = {
        'خسته‌ام|خستم|خسته‌|خستگ': [
            'آره شیفتا واقعاً خسته‌کننده‌ ان... یه نفس عمیق بکش و یادت باشه همیشه یه لیوان آب کنارت داشته باشی تا هیدراته بمونی 💧',
            'میدونم، این شغلتون خیلی انرژی می‌بره. ولی تو قوی‌ای، از پسش برمیای 💪',
            'خسته نباشی! یه چای داغ بخور و چند دقیقه چشماتو ببند، بهتر میشی 🍵'
        ],
        'شیفت بد|شیفت بدیه|شیفت سخته|شیفت سخت': [
            'آره بعضی شیفتا واقعاً طاقت‌فرساست. ولی تو قوی‌ای، از پسش برمیای 💪',
            'شیفتت شاید سخت باشه، اما با لبخندت می‌تونی روز رو برا بقیه هم شیرین‌تر کنی ✨',
            'یادت باشه بعد از شیفت، یه دوش آب گرم و یه خواب خوب همه چیز رو درست میکنه 🌙'
        ],
        'تموم نمیشه|تموم نشد|کی تموم میشه|چرا تموم نمیشه': [
            'آره بعضی وقتا انگار زمان متوقف شده... یه لیوان چای و یه چند دقیقه آرامش کمک میکنه ☕',
            'نگران نباش، همه‌چیز بالاخره تموم میشه. یه لبخند بزن و ادامه بده 🌟',
            'وقت که با عجله پیش نمیره، نفس عمیق بکش و صبور باش. تو از پسش برمیای 🧘'
        ],
        'شلوغه|شلوغ|دپارتمان شلوغ|پرکار': [
            ' همیشه پر از هیجان... نفس عمیق بکش، اولویت‌بندی کن و کار رو یکی یکی پیش ببر 🧘',
            'شلوغی یعنی نیاز به تو بیشتره. تو می‌تونی، چون بهترینی 💪',
            'یادت باشه تو این شلوغی، اول از همه مراقب خودت باش. یه جرعه آب و یه نفس عمیق 🧘'
        ],
        'پاهام|کمردرد|درد میکنه|درد داره|کمرم': [
            'میفهمم، خیلی سخته که طولانی مدت سر پا باشی و راه بری! کفش مناسب و استراحت بین شیفتا رو جدی بگیر. یه کمپرس گرم هم عالیه 🦶',
            'درد پا یا کمر نشون‌دهنده‌ی اینه که باید بیشتر به خودت برسی. تمرینات کششی ساده رو امتحان کن 🧘',
            'کفش طبی و چند دقیقه نشستن و الویت کردن پاها میتونه معجزه کنه 👟'
        ],
        'کی تورو ساخت|کی ساخته|سازنده|کی نوشته|برنامه‌نویس': [
            ...
            'برنامه‌نویسم یکی از همکاراته که کارش رو دوست داره. گفته که کمک به پرستارا یعنی کمک به بیمارا 💖',
            'سازندم یه پرستاره، و بهم گفته هرجوری شده باید تو کارت بهت کمک کنم 📱'
        ],
        'چطوری|خوبی|حالت چطوره|چطورین|چطورید': [
            'خوبم، ممنون! امیدوارم تو هم خوب باشی ❤️ چطور می‌تونم کمکت کنم؟',
            'عالی، چون دارم بهت کمک می‌کنم! 😊 تو چطوری؟',
            'من همیشه برای کمک بهت آماده‌ام! امیدوارم شیفتت خوب بوده باشه ☀️'
        ],
        ...
        'دستت درد نکنه|دست شما درد نکنه': [
            ...
            'ممنونم! امیدوارم بتونم بازم کمکت کنم 🤝',
            'خواهش می‌کنم! این وظیفمه که به بهترین پرستارا کمک کنم 💪'
        ],
        'ایول|آفرین|چه عالی|عالی': [
            'ممنون! امیدوارم همیشه موفق باشی ✨',
            'آفرین به تو! تو باعث افتخاری 🌟',
            'ممنونم! این انگیزه‌ست که بهتر کار کنم 💪'
        ],
        'بله|اوکی|باشه|چشم|حتماً|خوبه|خوب': [
            'چشم! هر وقت آماده‌ای، بگو 📝',
            'باشه! منتظر فرمان شما هستم 🚀',
            'خوبه! هر کاری میتونم برات انجام بدم، بگو 🤝'
        ],
                'سلام|هی|hi|hello|hey|درود|هلو|sup': [
            'سلام! وقت بخیر 🌸 چطور می‌تونم کمکت کنم؟',
            'درود بر شما!همه چی مرتبه؟ خوشحالم که اینجایی ✨',
            'سلام! امیدوارم روز خوبی داشته باشی ☀️',
            'هی! چه خبر؟ آماده‌ام که کمکت کنم 😊',
            'درود! چه کاری میتونم برات انجام بدم؟',
            '.سلام دوست من! خوش اومدی. اوضاع چطوره؟ 🌼',
            'سلام! نمیدونی چقدر خوشحالم که باهام حرف میزنی 🌟'
        ]
    };

    // Check if the user said any of the chat phrases (and no drug name or numbers)
    const hasDrug = Object.keys(drugDatabase).some(id => {
        const drug = drugDatabase[id];
        return lower.includes(drug.persianName.toLowerCase()) || lower.includes(drug.englishName.toLowerCase());
    });
    const hasNumber = /\d/.test(text);
    // Don't intercept if the user is trying to calculate (has drug or numbers)
    if (!hasDrug && !hasNumber && text.length < 50) {
        for (const [pattern, replies] of Object.entries(chatKeywords)) {
            const regex = new RegExp(pattern, 'i');
            if (regex.test(lower)) {
                const reply = replies[Math.floor(Math.random() * replies.length)];
                showVoiceResult(reply, 'success');
                return;
            }
        }
        // If no specific phrase matched but it's a short chat, still respond friendly
        if (text.length < 20) {
            ...
            showVoiceResult(genericReplies[Math.floor(Math.random() * genericReplies.length)], 'success');
            return;
        }
    }
...
function handleConvertVoice(text, params) {
    ...
    const elemKey = elemMap[elementName];
    if (!elemKey) {
